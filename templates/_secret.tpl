...
{{ define "library-chart.secretsFromFiles.tpl" }}
...
{{ $env_files_location := printf "files/secrets/%s/" .Values.env }}
{{ $default_files_location := printf "files/secrets/DEFAULT/" }}

{{/*
  # Traverse through env specific files and create Secrets
*/}}
...
{{/*
  # Traverse through Final override list and generate Secret YAMLs
*/}}
...
type: Opaque
data:
  {{ ($currentScope.Files.Glob $filepath).AsSecrets }}
---
{{- end -}}
